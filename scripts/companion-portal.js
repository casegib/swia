import { diceArray, TextEditorImpl } from "./utils.js";
...
export class SWIACompanionPortal extends BaseApplication {
  static DEFAULT_OPTIONS = {
    id: "swia-companion-portal",
    classes: ["swia-companion-portal-window"],
    tag: "section",
    position: {
      width: 1500,
      height: 900
    ...
    window: {
      title: "SWIA.Portal.Companion.Title",
  ...
  static PARTS = {
    main: {
      template: "systems/swia/templates/actors/companion-portal.hbs"
    }
  };
  ...
  get title() {
    return game.i18n.localize("SWIA.Portal.Companion.Title");
  }

  get template() {
    return "systems/swia/templates/actors/companion-portal.hbs";
  }
  ...
  async _buildContext() {
    const orderedActors = this._getOrderedCompanionActors();
